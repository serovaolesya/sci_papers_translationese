...
demonstrative_pronouns = {
    'это', 'этого', 'этому', 'этим', 'этот', 'этом', 'эта', 'этой', 'эту', 'этою',
    'эти', 'этих', 'этими', 'тот', 'то', 'того', 'тому', 'тем', 'том', 'та', 'той',
    'ту', 'тою', 'те', 'тех', 'теми',

    'такой', 'такое', 'такого', 'такому', 'таким', 'таком', 'такая', 'такую', 'такою',
    'такие', 'таких', 'такими',

    'этакий', 'этакого', 'этакому', 'этаким', 'этаком', 'этакая', 'этакой', 'этакую',
    'этакою', 'этакие', 'этаких', 'этакими',

    'таков', 'таковой', 'такового', 'таковому', 'таковым', 'таковом', 'такова',
    'таковая', 'таковую', 'таковою', 'таково', 'таковое', 'таковы', 'таковые',
    'таковых', 'таковыми',

    'сей', 'сий', 'сие', 'сего', 'сему', 'сим', 'сем', 'сия', 'сией', 'сию', 'сиею',
    'сии', 'сих', 'сими',

    'оный', 'оное', 'оного', 'оному', 'оным', 'оном', 'она', 'оная', 'оной', 'оную',
    'оною', 'оные', 'оных', 'оными',

    'столькое', 'столького', 'столькому', 'стольким', 'стольком', 'столькие', 'стольких', 'столькими',
    'так', 'столько',

    'указанный', 'указанное', 'указанного', 'указанному', 'указанным', 'указанном',
    'указанная', 'указанной', 'указанную', 'указанною', 'указанные', 'указанных',
    'указанными',

    'данный', 'данное', 'данного', 'данному', 'данным', 'данном', 'данная', 'данной',
    'данную', 'данною', 'данные', 'данных', 'данными'
}
...
relative_pronouns = {'кто', 'кого', 'кому', 'кого', 'кем', 'ком',
                     ...
                     'которым', 'котором', 'которая', 'которой', 'которую',
                     'которое', 'которые', 'которых', 'которым', 'которыми',
                     }
...
negative_pronouns = {'никто', 'никого', 'никому',
                     ...
                     'ничьих',
                     'некого', 'некому', 'некого', 'некем', 'никуда', 'некуда', 'незачем', 'нисколько'}
